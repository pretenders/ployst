...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Branch.head'
        db.alter_column(u'repos_branch', 'head', self.gf('ployst.core.repos.models.Revision')(max_length=40, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Branch.head'
        raise RuntimeError("Cannot reverse this migration. 'Branch.head' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Branch.head'
        db.alter_column(u'repos_branch', 'head', self.gf('ployst.core.repos.models.Revision')(max_length=40))
    ...
    models = {
        ...
        u'repos.branch': {
            ...
            'head': ('ployst.core.repos.models.Revision', [], {'max_length': '40', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
