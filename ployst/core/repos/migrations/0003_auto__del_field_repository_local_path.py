...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Repository.local_path'
        raise RuntimeError("Cannot reverse this migration. 'Repository.local_path' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Repository.local_path'
