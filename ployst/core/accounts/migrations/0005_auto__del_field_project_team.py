...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'accounts_project', 'team_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Project.team'
        raise RuntimeError("Cannot reverse this migration. 'Project.team' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Project.team'
        db.add_column(u'accounts_project', 'team',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='projects', to=orm['accounts.Team']),
                      keep_default=False)
